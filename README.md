...
> ⚠️ This repo is **not** an exploit and contains **no box secrets**. It is a convenience utility to reproduce a timestamp‑seeded password space **in your own lab**. Respect HTB rules and do not publish active spoilers.
